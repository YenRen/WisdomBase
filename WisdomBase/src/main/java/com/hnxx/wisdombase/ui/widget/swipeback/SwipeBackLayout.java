...
public class SwipeBackLayout extends FrameLayout {
    ...
    private void drawScrim(Canvas canvas, View child) {
        ...
        if ((mTrackingEdge & EDGE_LEFT) != 0) {
            ...
            canvas.clipRect(child.getLeft(), 0, getRight(), child.getTop() + mStatusBarHeight);
        }
    ...
    private void drawShadow(Canvas canvas, View child) {
        ...
        if ((mEdgeFlag & EDGE_TOP) != 0) {
        	mShadowTop.setBounds(childRect.left, childRect.top - mShadowTop.getIntrinsicHeight() + mStatusBarHeight, childRect.right,
            		childRect.top + mStatusBarHeight);
